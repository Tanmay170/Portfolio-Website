  ...
  return (
    <div className='w-full h-screen relative'>
        ...
        <div className='absolute w-full h-full top-0 flex flex-col justify-center text-center text-white p-4'>
            ...
            <h2 className='p-3' >Top Locations in India</h2>
            <form className='flex justify-between items-center max-w-[700px] mx-auto w-full border p-1 rounded-md text-black bg-gray-100/90'>
                <div>
                <input className='w-[300px] sm:w-[400px] font-[Poppins] focus:outline-none font-semibold text-xl p-3 bg-transparent' type="text" placeholder='Search Destinations'/>
                </div>
                <div>
